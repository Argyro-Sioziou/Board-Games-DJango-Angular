...
class Game(models.Model):
    ...
    def __str__(self):
        return "%s %s %s %s %s %s %s %s %s %s" % (self.name, self.creator, self.rules, self.price, self.rate, self.times_rated, self.min_age, self.max_age, self.min_num_of_players, self.max_num_of_players)
...
class Comment(models.Model):
    ...
    def __str__(self):
        return "%s %s %s" % (self.text, self.user, self.comment_date)
